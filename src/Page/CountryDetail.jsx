...
function CountryDetail() {
  ...
  return (
    <div className=" text-black h-full overflow-y-hidden  bg-[#f8fafb] flex justify-center items-center mx-auto">
      <div className="flex w-full h-screen items-center justify-center overflow-hidden relative flex-col">
        ...
        />
        <div className="flex w-full flex-row justify-around items-center mx-auto mt-60 p-10 ">
          <section className="flex flex-col relative mt-30 gap-5 justify-center items-center mx-auto">
            <div className="flex flex-col justify-center gap-0 absolute -top-30 left-2 ">
            ...
            <section className="flex flex-col justify-center items-center gap-10 bg-white border border-[#2a4c7141]  p-10 rounded-2xl max-w-150 shadow-sm">
              <div className="grid grid-cols-3 gap-10  ">
                ...
                <div className="flex flex-row justify-center items-center gap-5">
                  <p className="bg-[#e4f0f7] rounded-full w-20 h-11 flex justify-center items-center">
          ...
          <div className="flex flex-col  justify-center items-center mx-auto gap-5">
            ...
            <section className="bg-white border border-[#2a4c7141] p-20 flex justify-center items-center  mx-auto rounded-3xl  h-70 shadow-sm ">
              {weather && (
