  ...
  return (
    <div className=" text-black h-full overflow-y-hidden">
      <div className="flex w-full h-screen items-center justify-center overflow-hidden relative flex-col">
        ...
        />
        <div className="flex flex-row justify-center items-center gap-10 mt-40">
          <img
            src={selectedCountry.flags.png}
            alt=""
            className="w-30"
          />
          <h1 className="font-bold text-3xl">{selectedCountry.name}</h1>
        ...
        {weather && (
          <div className="flex mt-5 flex-col items-start gap-2">
            ...
            <p  className="font-bold text-xl">
              <span className="text-[#1d4362] font-bold text-2xl">Wind: </span>
